...
const Navbar = ({ user, onLogout }) => (
  <nav className="navbar-stg">
    ...
    <div className="navbar-right">
      {user ? (
        <>
          <Link to="/profile" style={{ marginRight: 16, color: '#2563eb', fontWeight: 600, textDecoration: 'none' }}>Profile</Link>          <span className="navbar-user-info">Logged in as <b>{user.username || user.email}</b></span>
